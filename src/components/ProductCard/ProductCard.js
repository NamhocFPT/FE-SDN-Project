...
const ProductCard = ({ food }) => {
  ...
  const handleAddToCart = async (e) => {
    ...
    try {
      ...
      if (!foodId) throw new Error("Thiếu ID sản phẩm");
  ...
  if (!food || !food.slug || !food.images || food.images.length === 0)
    return null;
  ...
  return (
    ...
    >
      ...
      <div className="product-card__info">
        ...
        <h3 className="product-card__name">{food.name}</h3>
